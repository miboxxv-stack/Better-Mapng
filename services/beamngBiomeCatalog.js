  ...
  european_template: {
    ...
    managedItemTemplates: {
      ...
      cypress_hedge_3m: {
        ...
        radius: 0.800000012,
        rigidity: 10.1999998,
        shapeFile: 'levels/italy/art/shapes/trees/trees_italy/cypress_hedge_3m.dae',
        tightnessCoefficient: 1,
        trunkBendScale: 0.0500000007,
        windScale: 0.200000003,
      },
      tree_beech_large_c: {
        name: 'tree_beech_large_c',
      ...
      tree_douglasfir_large_c: {
        name: 'tree_douglasfir_large_c',
        internalName: 'tree_douglasfir_large_c',
        class: 'TSForestItemData',
        branchAmp: 0.0599999987,
        detailAmp: 0.200000003,
        detailFreq: 5,
        mass: 55,
        radius: 0.5,
      ...
      eca_rock_medium_1: {
        name: 'eca_rock_medium_1',
        internalName: 'eca_rock_medium_1',
        class: 'TSForestItemData',
        annotation: 'ROCK',
        radius: 0.5,
        shapeFile: '/levels/east_coast_usa/art/shapes/rocks/eca_rock_medium_1.dae',
      },
      eca_rock_big_narrow: {
        name: 'eca_rock_big_narrow',
        internalName: 'eca_rock_big_narrow',
        class: 'TSForestItemData',
        annotation: 'ROCK',
        radius: 0.5,
        shapeFile: '/levels/east_coast_usa/art/shapes/rocks/eca_rock_big_narrow.dae',
      },
    },
    vegetationSelectors: {
      default: 'tree_beech_large_c',
      needle: 'tree_douglasfir_large_c',
      cypress: 'cypress_tree',
      olive: 'tree_beech_large_c',
      palm: 'tree_beech_large_c',
      bush: 'tree_beech_bush_d',
      hedgeBush: 'cypress_hedge_3m',
    },
    rockCandidates: ['eca_rock_medium_1', 'eca_rock_big_narrow', 'eca_rock_small'],
    groundCover: {
      materialName: 'GrassMiddle',
      materialDef: ITALY_GROUNDCOVER_MATERIAL,
      terrainLayer: 'Grass',
...
const WATER_PROFILES = {
  ...
  small_island: {
    ...
    waterDepthGradientTex: '/assets/materials/tileable/water/depthcolor_ramp/depthcolor_ramp_SI_b.png',
    waterFoamTex: '/assets/materials/tileable/water/water_effects/foam_b.color.dds',
    waterRippleTex: '/assets/materials/tileable/water/water_effects/ripple_nm.normal.dds',
    riverCubemap: 'cubemap_ocean_reflection',
    riverDepthGradientTex: '/assets/materials/tileable/water/depthcolor_ramp/depthcolor_ramp_SI_b.png',
    riverRippleTex: '/assets/materials/tileable/water/water_effects/ripple3_nm.normal.dds',
  },
  Industrial: {
...
export const BEAMNG_BIOMES = [
  ...
  {
    id: 'european',
    label: 'European (Template Mix, Non-Base-Game)',
    levelName: 'mapng_template',
    environmentProfile: { globalEnvironmentMap: 'BNG_Sky_02_cubemap' },
    waterProfile: WATER_PROFILES.european_template,
    assetSetIds: ['european_template', 'east_coast', 'italy', 'automation_test_track'],
    terrainLevelFallbacks: ['mapng_template', 'italy', 'east_coast_usa', 'automation_test_track'],
  },
  {
    id: 'utah',
    label: 'Utah',
